    ...
    <div className='bg-white p-5 rounded-lg space-y-2 shadow-lg'>
        ...
        <div className='md:flex md:justify-between md:items-center space-y-2 md:space-y-2'>
            <div className='flex gap-2'>
                <p className={`bg-green-600 p-2 rounded-lg text-white  capitalize`}>{task?.data?.status}</p>
                <p className={`bg-yellow-500 p-2 rounded-lg text-white capitalize`}>{task?.data?.priority}</p>
            </div>
